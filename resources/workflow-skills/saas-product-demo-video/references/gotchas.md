...
**Fix:** use a Studio-only preview preference that starts monitoring muted, without changing composition props, the rendered audio track, or any video-generation request. Or just know the first click of the play button will be loud.
