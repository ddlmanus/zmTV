...
export function MobileHistoryPage() {
  ...
  return (
    <div className="flex h-full flex-col relative overflow-hidden">
      {/* Dynamic Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#5A6F47]/10 via-transparent to-[#E6DDB5]/10" />
      ...
      <div
        className="absolute bottom-0 left-0 w-80 h-80 bg-gradient-to-tr from-[#A6C196]/10 to-transparent rounded-full blur-3xl animate-pulse"
