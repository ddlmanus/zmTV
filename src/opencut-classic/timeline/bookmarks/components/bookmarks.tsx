...
import { DEFAULT_TIMELINE_BOOKMARK_COLOR } from "@/opencut-classic/timeline/components/theme";
import { TIMELINE_BOOKMARK_ROW_HEIGHT_PX } from "@/opencut-classic/timeline/components/layout";
import { DEFAULT_FPS } from "@/opencut-classic/fps/defaults";
import {
...
import { clamp, formatNumberForDisplay } from "@/opencut-classic/utils/math";
import {
  ...
  return (
    ...
    >
      <button
        ...
        aria-label={t("freeTools.mediaTrimmer.editor.timelineRuler")}
        type="button"
        onWheel={handleWheel}
        onClick={(event) => {
    ...
    <>
      <div className="flex flex-col gap-2">
        <Label className="text-xs">
          {t("freeTools.mediaTrimmer.editor.note")}
        </Label>
        <Input
          placeholder={t("freeTools.mediaTrimmer.editor.addNote")}
          value={bookmark.note ?? ""}
      ...
      <div className="flex flex-col gap-2">
        <Label className="text-xs">
          {t("freeTools.mediaTrimmer.editor.color")}
        </Label>
          ...
          {bookmark.color &&
            bookmark.color.replace(/^#/, "").toUpperCase() !==
              ...
              <Button
                ...
                size="text"
                aria-label={t(
                  "freeTools.mediaTrimmer.editor.resetDefaultColor",
                )}
      ...
      <div className="flex flex-col gap-2">
        <Label className="text-xs">
          {t("freeTools.mediaTrimmer.editor.duration")}
        </Label>
      ...
      <Button
        ...
        aria-label={t("freeTools.mediaTrimmer.editor.deleteBookmark")}
      >
