...
import {
	getDbFromLinePos,
	getLinePosFromDb,
} from "@/opencut-classic/timeline/audio-display";
import { VOLUME_DB_MAX, VOLUME_DB_MIN } from "@/opencut-classic/timeline/audio-constants";
import { getElementVolume, hasAnimatedVolume } from "@/opencut-classic/timeline/audio-state";
import type { AudioElement } from "@/opencut-classic/timeline/types";
import {
	clamp,
