import {
	...
	type CommandResult,
} from "@/opencut-classic/commands/base-command";
...
import { splitAnimationsAtTime } from "@/opencut-classic/animation";
import { getSourceSpanAtClipTime } from "@/opencut-classic/retime";
import {
	addMediaTime,
	type MediaTime,
	roundMediaTime,
