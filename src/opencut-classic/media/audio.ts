...
import { shouldMaintainPitch } from "@/opencut-classic/retime/rate";
import type { MediaAsset } from "@/opencut-classic/media/types";
import { applyAudioMasteringToBuffer } from "@/opencut-classic/media/audio-mastering";
import type { AudioCapableElement } from "@/opencut-classic/timeline/audio-state";
import {
	hasAnimatedVolume,
	isElementMuted,
	resolveEffectiveAudioGain,
} from "@/opencut-classic/timeline/audio-state";
import { doesElementHaveEnabledAudio } from "@/opencut-classic/timeline/audio-separation";
import { canElementHaveAudio, hasMediaId } from "@/opencut-classic/timeline/element-utils";
import { canTrackHaveAudio } from "@/opencut-classic/timeline";
import { mediaSupportsAudio } from "@/opencut-classic/media/media-utils";
import { getSourceTimeAtClipTime, renderRetimedBuffer } from "@/opencut-classic/retime";
import { Input, ALL_FORMATS, BlobSource, AudioBufferSink } from "mediabunny";
import { TICKS_PER_SECOND } from "@/opencut-classic/wasm";
import {
	computeRmsBuckets,
	type SampleBucket,
} from "@/opencut-classic/media/waveform-summary";
