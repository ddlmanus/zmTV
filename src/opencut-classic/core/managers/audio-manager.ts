...
import type { AudioClipSource } from "@/opencut-classic/media/audio";
import { createAudioContext, collectAudioClips } from "@/opencut-classic/media/audio";
import {
	buildAudioGainAutomation,
	hasAnimatedVolume,
} from "@/opencut-classic/timeline/audio-state";
import { createAudioMasteringChain } from "@/opencut-classic/media/audio-mastering";
import {
