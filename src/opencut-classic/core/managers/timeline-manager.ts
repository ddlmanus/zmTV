...
import type { ElementBounds } from "@/opencut-classic/preview/element-bounds";
...
import { TimelineDragSource } from "@/opencut-classic/timeline/drag-source";
import { findTrackInSceneTracks } from "@/opencut-classic/timeline/track-element-update";
import { lastFrameMediaTime, type MediaTime, ZERO_MEDIA_TIME } from "@/opencut-classic/wasm";
import {
	canElementBeHidden,
	canElementHaveAudio,
} from "@/opencut-classic/timeline/element-utils";
import { isElementMuted } from "@/opencut-classic/timeline/audio-state";
import type {
	AnimationPath,
...
} from "@/opencut-classic/commands/timeline";
import type { InsertElementParams } from "@/opencut-classic/commands/timeline/element/insert-element";
import type {
	PlannedElementMove,
	PlannedTrackCreation,
} from "@/opencut-classic/timeline/group-move";
