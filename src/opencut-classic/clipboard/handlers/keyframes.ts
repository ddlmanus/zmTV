...
import { getChannelEntriesFromData } from "@/opencut-classic/animation/channel-data";
import { isScalarChannel } from "@/opencut-classic/animation/interpolation";
...
import { PasteKeyframesCommand } from "@/opencut-classic/commands/timeline";
import type {
	ClipboardHandler,
	KeyframeClipboardCurvePatch,
	KeyframeClipboardItem,
} from "../types";
import { roundMediaTime, subMediaTime, type MediaTime } from "@/opencut-classic/wasm";
