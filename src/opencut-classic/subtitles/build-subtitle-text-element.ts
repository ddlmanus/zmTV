import { FONT_SIZE_SCALE_REFERENCE } from "@/opencut-classic/text/typography";
import {
	getTextVisualRect,
	measureTextBlock,
	setCanvasLetterSpacing,
} from "@/opencut-classic/text/layout";
import { DEFAULTS } from "@/opencut-classic/timeline/defaults";
import { mediaTimeFromSeconds } from "@/opencut-classic/wasm";
import type { CreateTextElement } from "@/opencut-classic/timeline";
import type { TextBackground } from "@/opencut-classic/text/background";
import type {
	TextAlign,
	TextDecoration,
	TextFontStyle,
