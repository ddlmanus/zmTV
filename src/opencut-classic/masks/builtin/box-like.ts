import {
	...
	MIN_MASK_DIMENSION,
} from "@/opencut-classic/masks/dimensions";
...
import type { NumberParamDefinition, ParamDefinition } from "@/opencut-classic/params";
import {
	getBoxMaskHandlePositions,
	getBoxMaskOverlays,
} from "@/opencut-classic/masks/handle-positions";
import { snapBoxMaskInteraction } from "@/opencut-classic/masks/snap";
