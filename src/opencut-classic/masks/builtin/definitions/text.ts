...
import type {
	...
	TextMaskParams,
	MaskHandleId,
} from "@/opencut-classic/masks/types";
import { DEFAULTS } from "@/opencut-classic/timeline/defaults";
import { MIN_FONT_SIZE, MAX_FONT_SIZE } from "@/opencut-classic/text/typography";
import {
	drawMeasuredTextLayout,
	measureTextLayout,
	strokeMeasuredTextLayout,
} from "@/opencut-classic/text/primitives";
import { getTextMeasurementContext } from "@/opencut-classic/text/measure-element";
import { getTextVisualRect } from "@/opencut-classic/text/layout";
import {
	getBoxMaskHandlePositions,
	getBoxMaskRectOverlay,
} from "@/opencut-classic/masks/handle-positions";
import { computeFeatherUpdate } from "@/opencut-classic/masks/param-update";
import {
	setMaskLocalCenter,
	toGlobalMaskSnapLines,
} from "@/opencut-classic/masks/geometry";
import {
	snapPosition,
	snapRotation,
	snapScale,
