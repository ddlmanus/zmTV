import { mediaTimeToSeconds, roundMediaTime } from "@/opencut-classic/wasm";
import { getElementLocalTime } from "@/opencut-classic/animation";
import { resolveEffectParamsAtTime } from "@/opencut-classic/animation/effect-param-channel";
import {
	buildGaussianBlurPasses,
	intensityToSigma,
} from "@/opencut-classic/effects/definitions/blur";
import { effectsRegistry, resolveEffectPasses } from "@/opencut-classic/effects";
import type { Effect, EffectPass } from "@/opencut-classic/effects/types";
import { getSourceTimeAtClipTime } from "@/opencut-classic/retime";
import {
	DEFAULT_GRAPHIC_SOURCE_SIZE,
	resolveGraphicElementParamsAtTime,
} from "@/opencut-classic/graphics";
import {
	buildTextBackgroundFromElement,
	getTextMeasurementContext,
	measureTextElement,
} from "@/opencut-classic/text/measure-element";
import { resolveColorAtTime, resolveOpacityAtTime } from "@/opencut-classic/animation/values";
import { resolveTransformAtTime } from "@/opencut-classic/rendering/animation-values";
