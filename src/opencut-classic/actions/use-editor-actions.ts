...
import { useActionHandler } from "@/opencut-classic/actions/use-action-handler";
...
import { getElementsAtTime, hasMediaId } from "@/opencut-classic/timeline";
import { cancelInteraction } from "@/opencut-classic/editor/cancel-interaction";
import { invokeAction } from "@/opencut-classic/actions";
import { canToggleSourceAudio } from "@/opencut-classic/timeline/audio-separation";
import {
	activateScope,
	clearActiveScope,
	type ScopeEntry,
} from "@/opencut-classic/selection/scope";
