...
const dropdownMenuItemVariants = cva(
  "relative flex cursor-pointer select-none items-center gap-2 rounded-sm px-2.5 py-1.5 text-sm text-[#d7d9dd] outline-hidden data-[highlighted]:bg-[#2f3033] data-[highlighted]:text-white data-disabled:pointer-events-none data-disabled:opacity-50 [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "",
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "group/menu z-50 min-w-32 overflow-hidden rounded-md border border-[#2b2c2f] bg-[#1b1c1f] p-1 text-[#d7d9dd] shadow-[0_16px_40px_rgba(0,0,0,0.45)]",
      className,
    )}
    {...props}
  />
