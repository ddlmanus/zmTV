...
import { ColorPickerContent } from "@/opencut-classic/components/ui/color-picker";
import {
  Popover,
  PopoverTrigger,
...
} from "@/opencut-classic/background/blur";
import { DEFAULT_BACKGROUND_COLOR } from "@/opencut-classic/background/color";
import { patternCraftGradients } from "@/opencut-classic/data/colors/pattern-craft";
import { colors } from "@/opencut-classic/data/colors/solid";
import { syntaxUIGradients } from "@/opencut-classic/data/colors/syntax-ui";
  ...
  ({
    ...
    return (
      <button
        ...
        onClick={onSelect}
        type="button"
        aria-label={t("freeTools.mediaTrimmer.editor.selectBlur", {
          blur: blur.label,
        })}
      >
        <canvas
      ...
      () =>
        backgrounds.map((bg) => (
          <button
            ...
            onClick={() => onSelect(bg)}
            type="button"
            aria-label={t("freeTools.mediaTrimmer.editor.selectBackground", {
              background: bg,
            })}
          />
        )),
    ...
    <Popover>
      <PopoverTrigger asChild>
        <button
          ...
          type="button"
          aria-label={t(
            "freeTools.mediaTrimmer.editor.pickCustomBackgroundColor",
          )}
        >
          <span
...
const COLOR_SECTIONS = [
  {
    id: "colors",
    titleKey: "freeTools.mediaTrimmer.editor.colors",
    backgrounds: colors,
  ...
  {
    id: "pattern-craft",
    titleKey: "freeTools.mediaTrimmer.editor.patternCraft",
    backgrounds: patternCraftGradients,
    showCustomPicker: false,
  },
  {
    id: "syntax-ui",
    titleKey: "freeTools.mediaTrimmer.editor.syntaxUi",
...
export function BackgroundContent() {
  ...
  return (
    <div className="flex flex-col">
      ...
      >
        <SectionHeader>
          <SectionTitle>{t("freeTools.mediaTrimmer.editor.blur")}</SectionTitle>
        </SectionHeader>
        <SectionContent>
