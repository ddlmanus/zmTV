...
function getCategoryAccent(
  ...
  switch (category) {
    case "video":
      return "from-[#5A6F47] to-[#6D8856]";
    case "image":
      return "from-[#6D8856] to-[#A6C196]";
    case "audio":
      return "from-[#A6C196] to-[#5A6F47]";
    case "3d":
      return "from-[#E6DDB5] to-[#6D8856]";
    default:
      return "from-[#5A6F47] to-[#A6C196]";
  }
}
...
export function SmartPlaygroundPage() {
  ...
  const { requestApiKey } = useApiKeyStore();
