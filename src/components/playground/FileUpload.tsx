      ...
      <div className="space-y-1.5">
            ...
            {urls.map((url, index) => {
              ...
              return (
                <div
                  key={`${url}-${index}`}
                  className={cn(
                    "group flex h-9 items-center gap-2 rounded-md border border-[hsl(var(--playground-border)/0.48)] bg-[hsl(var(--playground-panel))] px-2 transition-colors hover:border-[hsl(var(--playground-accent)/0.35)] hover:bg-[hsl(var(--playground-tab-active)/0.18)]",
                ...
                >
                  ...
                  >
                    <span className="flex h-6 w-6 shrink-0 items-center justify-center overflow-hidden rounded bg-[hsl(var(--playground-tab-active)/0.22)] text-muted-foreground">
                      {mediaType === "image" ? (
                        <img
                          src={url}
                          alt=""
                  ...
                  <Button
                    variant="ghost"
                    size="icon"
                    className="h-6 w-6 shrink-0 text-muted-foreground hover:bg-[hsl(var(--playground-tab-active)/0.22)] hover:text-destructive"
            ...
            {captureMode === "upload" && (
              <div className="flex items-center gap-1.5">
                <div
                  {...getRootProps()}
                  className={cn(
                    "flex h-9 w-28 shrink-0 cursor-pointer items-center justify-center gap-1.5 rounded-md border border-dashed border-[hsl(var(--playground-border)/0.6)] bg-[hsl(var(--playground-panel))] px-2 text-xs text-muted-foreground transition-colors",
                    isDragActive &&
                      "border-[hsl(var(--playground-accent))] bg-[hsl(var(--playground-accent)/0.08)] text-[hsl(var(--foreground))]",
                    disabled && "cursor-not-allowed opacity-50",
                    !disabled &&
                      !isDragActive &&
                      "hover:border-[hsl(var(--playground-accent)/0.4)] hover:bg-[hsl(var(--playground-tab-active)/0.18)]",
                  )}
                >
                  <input {...getInputProps()} />
                  {isUploading ? (
                ...
                <Input
                  ...
                  disabled={disabled}
                  className="h-9 min-w-0 flex-1 border-[hsl(var(--playground-border)/0.48)] bg-[hsl(var(--playground-panel))] text-xs text-[hsl(var(--foreground))] placeholder:text-muted-foreground"
                />
                {urlInput.trim() && (
                  <Button
                    type="button"
                  ...
                  <div className="flex shrink-0 gap-1">
                    {supportsCamera && (
                      <Button
                        ...
                        disabled={disabled || isUploading}
                        className="h-9 w-9 border-[hsl(var(--playground-border)/0.48)] bg-[hsl(var(--playground-panel))]"
        ...
        {isUploading && (
          <div className="flex items-center gap-2">
            <div className="h-1 flex-1 overflow-hidden rounded-full bg-[hsl(var(--playground-tab-active)/0.28)]">
              <div
