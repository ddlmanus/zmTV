            ...
            return (
              ...
              >
                ...
                <div className="aspect-square bg-muted/70 flex items-center justify-center">
                  ...
                  {is3D && (
                    <div className="flex h-full w-full flex-col items-center justify-center gap-2 bg-[radial-gradient(circle_at_50%_20%,#5A6F47_0%,#27351F_52%,#11170F_100%)] text-xs text-white/80">
          ...
          return (
            ...
            >
              ...
              {is3D && (
                <button
                  type="button"
                  className="flex h-full min-h-[360px] w-full flex-col items-center justify-center gap-3 bg-[radial-gradient(circle_at_50%_20%,#5A6F47_0%,#27351F_52%,#11170F_100%)] text-white transition-opacity hover:opacity-95"
                  onClick={() => setFullscreenIndex(index)}
                >
