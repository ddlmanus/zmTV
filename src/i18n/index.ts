...
// Default to Simplified Chinese. Only follow the system language when the user
// explicitly chooses "auto" in settings.
const effectiveLanguage =
  savedLanguage === "auto" ? undefined : savedLanguage || "zh-CN";
