...
export const WorkflowOverlayNode = memo(function WorkflowOverlayNode({
  ...
  const canvasInteractionActive = Boolean(
    dragging ||
      data.isDragging ||
      data.isViewportMoving ||
      data.nodeEventsSuppressed,
  );
  const showFloatingControls =
    isSelected && !data.suppressFloatingControls && !canvasInteractionActive;
    ...
    >
      ...
      {node.kind === "text" ? (
        <TapNowTextNode
          ...
          dragging={canvasInteractionActive}
