export const LOVART_FONT_OPTIONS = [
  "3D Isometric",
  "ABeeZee",
  "Abel",
  "Abhaya Libre",
  ...
  "Silkscreen",
  "Silverblade",
  "Silverblade Decorative",
  "Silverblade Fill",
  "Silverblade Outline",
  "Silverblade Thinline",
  "Simonetta",
  "Single Day",
  "Sintony",
  "SirinStencil",
...
export function getLovartFontSvgUrl(fontName: string) {
  return `/images/lovart-fonts/font-family-name-svg/${encodeURIComponent(fontName.replace(/\s+/g, "_") + ".svg")}`
}
